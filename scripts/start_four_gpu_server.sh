...
export AGENTLODGE_FILAMENT_FAST_GROUNDING="${AGENTLODGE_FILAMENT_FAST_GROUNDING:-0}"
export AGENTLODGE_FILAMENT_FOOT_GROUNDING="${AGENTLODGE_FILAMENT_FOOT_GROUNDING:-1}"
export AGENTLODGE_EARLY_LODGE_GENERATION="${AGENTLODGE_EARLY_LODGE_GENERATION:-0}"
export AGENTLODGE_EARLY_LODGE_WAIT_SECONDS="${AGENTLODGE_EARLY_LODGE_WAIT_SECONDS:-120}"
...
export MAESTRO_FRONT_FACING="${MAESTRO_FRONT_FACING:-1}"
